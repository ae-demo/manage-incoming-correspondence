...
const RESOURCE = env.CORRESPONDENCE_AUTH_RESOURCE;
...
const userManager = new UserManager({
  authority: env.CORRESPONDENCE_AUTH_ISSUER,
  client_id: env.CORRESPONDENCE_AUTH_CLIENT_ID,
  ...
  response_type: "code",
  scope: env.CORRESPONDENCE_AUTH_SCOPES,
